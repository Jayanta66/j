...
export function Home(){
  ...
  <div class="container-fluid purple">
    <a class="navbar-brand" href="/">joyjagatbondu ..........add page </a>
    ...
    <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/add">addpppppppppp</a>
        </li>
    ...
    <form class="pic" onSubmit={submit} > 
      <div class="form-group " >
        <label>Title : </label>
        <input  class="form-control re"  placeholder="Please Enter Your Title ..........add page" value={form.name} onChange={e=>setForm({...form, name:e.target.value})} required/>
      ...
      <div class="form-group">
        ...
        <textarea  class="form-control"  placeholder="Please Enter Your Details ..........add page" value={form.details} onChange={e=>setForm({...form, details:e.target.value})}></textarea>
        </div>
